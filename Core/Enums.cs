...
namespace FB.Core
{
    ...
    public enum ToiletryParcelType
    {
        [Display(Name = "Be-spoke Parcel")]
        Bespoke = 0,
        [Display(Name = "Anonymous Parcel")]
    ...
    public enum ActivityLogType
    {
        ...
        Feedback = 15,
        [Display(Name = "Toiletry Parcel")]
        ToiletryParcel = 16,
        [Display(Name = "Family Record")]
        FamilyRecord = 17,
        [Display(Name = "Toiletry Stock")]
        ToiletryStock = 18
    }
    public enum TokenType
    {
        [Display(Name = "Charity Token")]
        TokenTypeCharity = 1,
        [Display(Name = "Branch Token")]
        TokenTypeBranch = 2
    }
    public enum AchievementFrequency
    {
        [Display(Name = "Week")]
        Weekly = 1,
        [Display(Name = "Month")]
    ...
    public enum VolunteerAchievementStatus
    {
    ...
    public enum AchievementWorkType
    {
        [Display(Name = "Packing")]
        Packing = 1,
        [Display(Name = "Delivery")]
